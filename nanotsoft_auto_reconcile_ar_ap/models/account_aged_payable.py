...
class ReportAccountAgedPayable(models.Model):
    ...
    def _get_reports_buttons(self):
        res = super(ReportAccountAgedPayable, self)._get_reports_buttons()
    ...
    def partner_auto_reconcile(self, options):
        ...
        for partner in partner_list:
            manual_reconcilation_data = account_reconcilation_obj.get_data_for_manual_reconciliation('partner',[partner],'payable')
